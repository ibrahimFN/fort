...
disablewhisperperfectly   : 囁きが無効の場合、所有者も使えなく化するかどうかの設定
disablepartychatperfectly : パーティーチャットが無効の場合、所有者も使えなく化するかどうかの設定
...
unready                                   : 準備中 状態にする
sitout                                    : 欠場中 状態にする
skinlock                                  : skinlock [true / false] スキンの変更をするかどうかの設定
baglock                                   : baglock [true / false] バッグの変更をするかどうかの設定
picklock                                  : picklock [true / false] ツルハシの変更をするかどうかの設定
